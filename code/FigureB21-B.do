...
*|
*| Function: Replicates Figure B21-B
*|==============================================================================
...
twoway scatter gdppc23_pval year if country=="Cuba" & year>=1959,   ///
...
graph save "$path/figures/FigureB21-B.gph", replace
graph export "$path/figures/FigureB21-B.png", replace
