...
*|
*| Function: Replicates Figure B21-E
*|==============================================================================
...
*| Graph Setup
global ytitle	= "Adjusted GDP per capita - Soviet aid index (1958=100)"
global xtitle   = "Year"
global treat_graph  = $treat_y -1

*| Unadjusted GDP per Capita
		   
twoway line adj_transf23_norm year if country=="Cuba", lpattern(solid) 	 ///
	|| line adj_transf23_synth_norm year if country=="Cuba", lpattern(dash) ///  
...
graph save "$path/figures/FigureB21-E.gph", replace
graph export "$path/figures/FigureB21-E.png", replace
