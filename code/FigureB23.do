...
*|
*| Function: Generates SDID estimates for GDP; Produces Figure B23
*|==============================================================================
...
graph save g2_1959 "$path/figures/FigureB23-A", replace
graph export "$path/figures/FigureB23-A.png", as(png) replace
...
graph save "$path/figures/FigureB23-B", replace
graph export "$path/figures/FigureB23-B.png", as(png) replace
...
graph save g2_1959 "$path/figures/FigureB23-C", replace
graph export "$path/figures/FigureB23-C.png", as(png) replace
...
graph save "$path/figures/FigureB23-D", replace
graph export "$path/figures/FigureB23-D.png", as(png) replace
...
graph save g2_1959 "$path/figures/FigureB23-E", replace
graph export "$path/figures/FigureB23-E.png", as(png) replace
...
graph save "$path/figures/FigureB23-F", replace
graph export "$path/figures/FigureB23-F.png", as(png) replace
