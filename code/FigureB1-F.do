...
*|
*| Function: Replicates Figure B1-F
*|==============================================================================
...
twoway scatter adj_transf13_pval year if country=="Cuba" & year>=1959,   ///
...
graph save "$path/figures/FigureB1-F.gph", replace
graph export "$path/figures/FigureB1-F.png", replace
