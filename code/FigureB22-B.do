...
*|
*| Function: Replicates Figure B22-B
*|==============================================================================
...
twoway scatter us_trade_pval year if country=="Cuba" & year>=1959 & year<=1972, ///
...
graph save "$path/figures/FigureB22-B.gph", replace
graph export "$path/figures/FigureB22-B.png", replace
