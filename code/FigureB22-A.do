...
*|
*| Function: Replicates Figure B22-A
*|==============================================================================
...
// Graph Setup
global ytitle	= "Total Trade with the US index (1958=100)"
global xtitle   = "Year"
global treat_graph  = $treat_y - 1
	   
// Total Trade with the US
twoway line us_trade_norm year if country=="Cuba", lpattern(solid)  ///
	|| line us_trade_synth_norm  year if country=="Cuba", lpattern(dash) ///
...
graph save "$path/figures/FigureB22-A.gph", replace
graph export "$path/figures/FigureB22-A.png", replace
