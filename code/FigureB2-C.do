...
*|
*| Function: Replicates Figure B2-C
*|==============================================================================
...
twoway line trade_th year if country=="Cuba", lpattern(solid)  ///
	|| line trade_th_synth  year if country=="Cuba", lpattern(dash) ///
	xline($treat_graph)	 ///
	xlabel(1932(5)1992, labsize(small)) ///
...
graph save "$path/figures/FigureB2-C.gph", replace
graph export "$path/figures/FigureB2-C.png", replace
