...
*|
*| Function: Replicates Figure B1-D
*|==============================================================================
...
twoway scatter adj_mad13_pval year if country=="Cuba" & year>=1959,   ///
...
graph save "$path/figures/FigureB1-D.gph", replace
graph export "$path/figures/FigureB1-D.png", replace
