...
*|
*| Function: Replicates Figure B18-F
*|==============================================================================
...
twoway scatter adj_transf23_pval year if country=="Cuba" & year>=1959,   ///
...
graph save "$path/figures/FigureB18-F.gph", replace
graph export "$path/figures/FigureB18-F.png", replace
