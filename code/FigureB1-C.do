...
*|
*| Function: Replicates Figure B1-C
*|==============================================================================
...
twoway line adj_mad13 year if country=="Cuba", lpattern(solid) 	 ///
	|| line adj_mad13_synth year if country=="Cuba", lpattern(dash) ///
	   xline($treat_graph)		 ///
...
graph save "$path/figures/FigureB1-C.gph", replace
graph export "$path/figures/FigureB1-C.png", replace
